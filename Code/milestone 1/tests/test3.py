class Tool:
  def __init__(self, name_: str, ver_no_: float):
    self.name: str = name_
    self.version: float = ver_no_
...
class Compiler:
  def __init__(self, ip_lang_: str, op_lang_: str, lexer_name_: str, lexer_version_: float, parser_name_: str, parser_version_: float, gp_no_: int, member_names_: list[str]):
...
def main():
  obj: Compiler = Compiler("Python", "X86", "Flex", 2.6, "Bison", 3.8, 32, [
