...
Options:
 ...
 -o, --output <outputfile>      set the output AST pdf as <outputfile>
 -h, --help                     display this help

Example:
 ./make_ast.sh test1.py graph.pdf
 ./make_ast.sh -v --input test1.py -o graph.pdf
...
make
./parser $VERBOSE $INPUT_FILE $OUTPUT_FILE